...
** Guess the person I'm thinking of **
...
** function display() the correct letter when userchoice === computerGuess **
...
6. Wins: (# of times user guessed the word correctly).
   ...
   * As the user guesses the correct letters, reveal them: `m a d o _  _ a`.
    ...
    ** every === letter > to display > and add user wins++ **
...
** variable that shows the letters guessed**

9. After the user wins/loses the game should automatically choose another word and make the user play it.

** after the letters remaining end > another word from the array gets add**
